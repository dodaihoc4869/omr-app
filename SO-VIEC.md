...
- [ ] "phiếu dựng vẫn bị lỗi có thêm lời giải" (phần còn lại: phiếu bài luyện gửi em ra bản CÓ lời giải) | bằng chứng: (chưa có)
- [ ] "rút câu luyện của học sinh bị lỗi lời giải" (ảnh: phiếu em, thanh ghi "Đã xem lời giải 20/20 câu", ô C tô xanh lá lộ đáp án) | bằng chứng: (chưa có)

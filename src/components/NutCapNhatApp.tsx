...
// NÚT "LẤY BẢN MỚI" (tải bản app mới nhất về máy này). Trước 21/09 nằm cuối trang Hôm nay; Bảng tin bản 3 là trang CHỈ ĐỌC, không cuộn, không nút hành động
// ⇒ nút dời sang Cài đặt (mục "Cập nhật app") và vẫn còn ở màn Hôm nay dự phòng (HomNayCu). Nội dung hàm giữ y nguyên chỗ cũ.

export default function NutCapNhatApp() {

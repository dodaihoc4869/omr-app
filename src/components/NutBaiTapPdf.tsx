    ...
    <div className="flex flex-col" style={{ gap: 'var(--k3)' }}>
      ...
      <div>
        ...
        <div style={{ ...NHAN_NHO, marginTop: 'var(--k1)' }}>
          Nhãn lý thuyết / bài tập lấy thẳng từ kho. Đề nào chưa tải lại thì A.I Đỗ Đại Học tạm phân loại từ mặt chữ, câu chưa chắc chỉ vào phiếu khi chọn Ngẫu nhiên.
        </div>
      </div>

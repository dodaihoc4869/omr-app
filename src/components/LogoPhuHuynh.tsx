 ...
 */
export default function LogoPhuHuynh({
  size = 36,
  hienChu = false,
  className = '',
  phuDe = 'PHỤ HUYNH',
  ...
  return (
    <div className={`inline-flex items-center gap-2.5 select-none ${className}`}>
      <img src={`${import.meta.env.BASE_URL}logo-ph-192-v2.png`} width={size} height={size} className="shrink-0 rounded-xl" alt="" />

...
describe('phạm vi bộ sinh lớp tương thích (nhóm B + C + A2)', () => {
  it('đúng 11 tệp: 4 nhóm B + 2 modal báo cáo + 3 khối con nằm trong modal + PhongChoGame (vào thi) + BangTinPhuHuynh (C8)', () => {
    expect(TEP.map((t: string) => path.basename(t)).sort()).toEqual(
      ['BangTinPhuHuynh.tsx', 'BaoCaoCaThiHocSinhModal.tsx', 'BaoCaoCaThiPhuHuynhModal.tsx', 'BieuDoTienBoGoogle.tsx', 'DongDemCau.tsx', 'KhoiBaPhan.tsx', 'KhoiCauSai.tsx', 'KhoiKhacPhuc3CheDo.tsx', 'LuyenDeChuan.tsx', 'ModalKhacPhucCauSai.tsx', 'PhongChoGame.tsx'].sort(),
    )
  })

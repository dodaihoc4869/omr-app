...
export const LOI_TOT: { chu: string; the: TheDeKiem; dang: string[]; bac: 'dung_bac' | 'thap_hon_mot_bac' | 'cao_hon_mot_bac' }[] = [
  ...
  { chu: 'Em vừa đúng lại 4 câu từng sai. Khiên đầu tiên của Rồng Lửa chỉ mở sau 21 ngày đạt nhiệm vụ ngày, nên hôm nay hãy thử mấy câu Thuỷ phân ester nhé.', the: THE, dang: ['ESTE.THUY_PHAN'], bac: 'dung_bac' },

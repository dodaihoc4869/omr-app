...
describe('EXP học tập đồng bộ',()=>{
 it('chặn cộng trùng, trần ngày VN, không kéo điểm trước reset, tự nạp cấp',async()=>{
  ...
  expect(creditAcademic(p,[{key:'tomorrow',at:'2026-09-16T18:00:00Z',amount:60}])).toBe(60);expect(p.cap).toBe(2) // sửa có chủ ý 21/09: thanh đầu 120 → 160 (đường cấp mới), 100 + 60 = 160
 })

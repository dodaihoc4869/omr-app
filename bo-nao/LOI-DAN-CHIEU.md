...
4. Khi mọi trợ lý xong: chạy `node scripts/bo-nao/nop.mjs --chieu --xem-truoc [ngày]` rồi DỪNG. Phiên này KHÔNG có cách nộp thật — người chạy sẽ đọc `bo-nao/<ngày>/chieu/xem-truoc.md` rồi tự nộp. Câu trả lời cuối ≤ 6 dòng tiếng Việt: ngày, số em được mời, số bị loại và lý do gộp, đường dẫn `xem-truoc.md`.

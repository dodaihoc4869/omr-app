...
3. Chia việc cho trợ lý con, gọi song song trong CÙNG MỘT lượt và CHỜ xong hết (KHÔNG chạy nền, KHÔNG kết thúc lượt khi còn trợ lý chưa xong), mỗi trợ lý MỘT tệp vào → MỘT tệp `ra/<cùng tên>.json` đúng KHUÔN:
...
- Xưng "Bộ não A.I", gọi "anh chị", gọi học sinh là "con". Kính trọng, ấm, ngắn. CẤM: so với con nhà khác, nhãn năng lực, dự đoán điểm thi, chuyện sức khoẻ/tâm lý, tiền bạc, quảng cáo lớp học, MỌI thứ của game (thần thú, EXP, khiên, mảnh khiên, Đoàn Hộ Tống, Đảo thần thú / đảo của em, Võ đài, game, trò chơi — thầy lệnh 21/09: app phụ huynh KHÔNG hiện gì của game, lời cho phụ huynh và thư tuần cũng vậy; máy loại cả lời bằng danh sách từ cấm), nghi chép bài (chuyện này CHỈ báo thầy).
...
Thú của em nằm ở `thanThu` của thẻ: `ten` (được nhắc) và `chuoiNgay`. LUẬT CẤP MỚI (từ 22/09): lời nói về "cho {tên thú} ăn hôm nay", được nêu số của luật (200 = thú ăn no khi em đạt nhiệm vụ ngày · 120 · 4 câu · 21 = "21 ngày đạt nhiệm vụ ngày" mở khiên đầu); CẤM số cấp, "còn thiếu N EXP", số mảnh khiên (máy ẩn `cap`, `expConThieu`, `exp`, `manhKhien` khỏi thẻ bạn đọc và loại lời vi phạm); nhắc khiên CHỈ kèm "21 ngày đạt nhiệm vụ ngày". Khoá vắng = không có số thật ấy; vắng cả khối = em chưa chọn thú ⇒ KHÔNG nhắc thú, KHÔNG nêu tên riêng nào; NÊN đặt ở CÂU CUỐI một câu mời chọn thú ("chọn một thần thú" / "chọn thần thú" / "chọn một bạn đồng hành"), không tên thú, không hứa EXP cụ thể (tối 21/09: 35/60 em chưa chọn thú). Tên thú chỉ lấy đúng từ `thanThu.ten`.
**Khung lời mời — BA Ý BẮT BUỘC, đủ cả ba** (lượt thử 12:31 tối 21/09: 52/52 lời đúng số nhưng cụt ý giữa, 47/52 mở bằng "Hôm qua"): (1) điều em đã làm bằng số thật (số "đúng" = số đã gặp − số sai của dạng) → (2) Ý NGHĨA với chính em: MỘT mệnh đề ngắn nói điều đó CHO THẤY GÌ ở em, dựa dữ kiện, CẤM khen chung chung → (3) lời mời có lực ("Hôm nay em hãy…", "Thử ngay mấy câu…", "Cùng <tên thú> luyện…") gắn với thú bằng TÊN thú và "cho thú ăn hôm nay" (không nêu số cấp / EXP còn thiếu). Không hứa điều không chắc: EXP chỉ có khi trả lời đúng, máy chủ có thể chọn được ít câu hơn. Mỗi em một lời KHÁC nhau: ≥ 4 kiểu mở đầu, không mở bằng "Hôm qua" quá 1/3 số lời, mỗi lời một đuôi khác nhau (máy cảnh báo cả lô khi quá nửa "Hôm qua", < 4 kiểu mở đầu hoặc đuôi lặp).
**7 lời mẫu CẤM** (máy sẽ loại cả thử thách):
1. Em đã nắm chắc Thuỷ phân ester sau 4 ngày, thử mấy câu nữa nhé. — nhãn năng lực "nắm chắc".
2b. Rồng Lửa còn thiếu 40 EXP để lên cấp 6, hôm nay thử mấy câu nhé. — nêu số cấp và EXP còn thiếu.
2c. Rồng Lửa sắp có khiên đầu tiên, em chăm 4 ngày liền rồi, hôm nay hãy thử vài câu nhé. — nhắc khiên mà không nói luật "21 ngày đạt nhiệm vụ ngày".
...
6. Rồng Lửa đang có 3 mảnh khiên, hôm nay em hãy thử vài câu nhé. — nêu số mảnh khiên.
...
**QUY TRÌNH LƯỢT CHIỀU** (`bash scripts/bo-nao/chay-chieu.sh`, thường ~18:30): C0 `node scripts/bo-nao/lay.mjs --chieu [ngày]` (chỉ em có tín hiệu: `mocDangKhen`, làm bài hôm qua/3 ngày; không vắng) → C1 chia tệp `vao/chieu-NN.json` cho trợ lý con (mô hình sonnet, MỘT tệp vào → MỘT tệp ra `ra/chieu-NN.json`, dặn đọc `LUAT-CHIEU.md`) → C2 `node scripts/bo-nao/nop.mjs --chieu --xem-truoc` (kiểm khuôn tại máy thầy, GHI `chieu/xem-truoc.md` + `bao-cao.md`, KHÔNG nộp) → dừng. Người chạy đọc `xem-truoc.md` rồi mới `bash scripts/bo-nao/chay-chieu.sh --nop` (không gọi AI lại). Lượt chiều không đụng lượt đêm: thư mục riêng `bo-nao/<ngày>/chieu/`.

## SẮP CÓ — V4 "vòng khép kín" + V3 "mục tiêu tuần" (thầy chốt 21/09) — **CHƯA BẬT: đêm này KHÔNG ghi `huongEm`, `mucTieuTuan`, `loiMucTieu`**
Khuôn và luật đã có ở mã kiểm (`kiemKhuon`), máy chủ chưa đo / chưa nhận; khi Code 3 xong và Boss bật cờ, mục này thành việc thật. **V4:** `huongEm` = ≤ 2 NHÃN KÍN (`thu_thach|tran_an`, `ngan|giai_thich`, `som|muon`; mỗi trục một nhãn), mỗi nhãn kèm 1–4 SỐ bằng chứng có trong thẻ; KHÔNG chữ tự do; em không thấy; sống 14 ngày; nhãn đang có làm bộ NHẸ đi (`tran_an` ⇒ không `cao_hon_mot_bac`, `ngan` ⇒ ≤ 5 câu). **V3:** `mucTieuTuan` = `{ dang, den }` (MỘT dạng, đích = bậc hiện tại + 1, dạng đủ tin và không yếu) + `loiMucTieu` ≤ 160 ký tự, CHỈ ở ngày soi kỹ hằng tuần của em, mỗi em một mục tiêu đang chạy. Hai lời (`loiMoi`, `loiMucTieu`) KHÔNG nói ra điều mình "biết" về em ("em thích…", "mình biết em…"). Hợp đồng số liệu của thẻ: `docs/hop-dong-bo-nao-v3-v4-2109.md`.

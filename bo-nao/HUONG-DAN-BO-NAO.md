...
Số THẬT của thần thú nằm ở `thanThu` của thẻ: `ten`, `cap`, `expConThieu` (còn thiếu bao nhiêu EXP để lên cấp), `chuoiNgay`. (`manhKhien` / `manhKhienTong` TẠM KHÔNG dùng: thầy đang siết khiên lên 36 ngày, số /12 sắp đổi.) Khoá vắng = không có số thật ấy; vắng cả khối = em chưa chọn thú ⇒ KHÔNG nhắc thú, KHÔNG nêu tên riêng nào; NÊN đặt ở CÂU CUỐI một câu mời chọn thú ("chọn một thần thú" / "chọn thần thú" / "chọn một bạn đồng hành"), không tên thú, không hứa EXP cụ thể (tối 21/09: 35/60 em chưa chọn thú). Tên thú chỉ lấy đúng từ `thanThu.ten`.
**Khung lời mời — BA Ý BẮT BUỘC, đủ cả ba** (lượt thử 12:31 tối 21/09: 52/52 lời đúng số nhưng cụt ý giữa, 47/52 mở bằng "Hôm qua"): (1) điều em đã làm bằng số thật (số "đúng" = số đã gặp − số sai của dạng) → (2) Ý NGHĨA với chính em: MỘT mệnh đề ngắn nói điều đó CHO THẤY GÌ ở em, dựa dữ kiện, CẤM khen chung chung → (3) lời mời có lực ("Hôm nay em hãy…", "Thử ngay mấy câu…", "Cùng <tên thú> luyện…") kèm phần thưởng bằng số thật (EXP còn thiếu + cấp). Không hứa điều không chắc: EXP chỉ có khi trả lời đúng, máy chủ có thể chọn được ít câu hơn. Mỗi em một lời KHÁC nhau: ≥ 4 kiểu mở đầu, không mở bằng "Hôm qua" quá 1/3 số lời, mỗi lời một đuôi khác nhau (máy cảnh báo cả lô khi quá nửa "Hôm qua", < 4 kiểu mở đầu hoặc đuôi lặp).
...
2. Chuỗi 4 ngày liền, hôm nay đến lúc nâng tầm: hãy thử câu khó hơn một bậc ở dạng Thuỷ phân ester, vì em đã đúng 8 trong 9 câu dạng này. Rồng Lửa còn thiếu 40 EXP lên cấp 6.
3. Hôm qua em làm 8 câu, đúng 7 câu, nhịp đều như vậy là nền vững cho bài dài. Thử ngay vài câu Lipid béo, Rồng Lửa còn thiếu 40 EXP để lên cấp 6.
4. Rồng Lửa đang chờ em ở cấp 6, còn thiếu 40 EXP. Em vừa đúng lại 4 câu từng sai, nên hôm nay hãy thử mấy câu Thuỷ phân ester để chắc thêm.
5. Hôm nay mình lùi một bậc ở dạng Carb phân loại để em lấy lại nhịp: làm chậm, kỹ từng câu. Rồng Lửa vẫn chờ em, còn thiếu 40 EXP.
...
Vì sao tốt: mở bằng việc em đã làm (số thật) · có MỘT mệnh đề ý nghĩa dựa dữ kiện · mời bằng động từ có lực nhưng không nêu số câu, không hứa · phần thưởng nói bằng EXP còn thiếu + cấp hoặc bằng điều chắc chắn có (câu đúng thì có EXP) · tám kiểu mở đầu khác nhau · giọng ấm, không nhãn năng lực.

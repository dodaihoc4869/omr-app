...
-- `chu` là câu đơn giản cho thầy ("Nhắc nộp bài lỗi, A.I Đỗ Đại Học sẽ thử lại"), KHÔNG chứa chi tiết kỹ thuật. Chỉ `/gv/bang-tin` đọc. Chưa chạy migration thì việc ghi lỗi im lặng bỏ qua và bảng tin ghi `lyDoThieu.nhatKyMay`.

...
var L = { async fetch(e, t) {
	...
	if (e.method === "GET" && r === "/ten-theo-sbd") return k(t, (n.searchParams.get("maCa") ?? "").trim(), (n.searchParams.get("sbd") ?? "").trim());
	...
	return r === "/vao-thi" ? p(t, i) : r === "/luu-tam" ? m(t, i) : r === "/nop" ? h(t, i) : r === "/trang-thai" ? g(t, i) : r === "/phong-cho" ? y(t, i) : l(e, t, i) ? r === "/ca/day" ? x(t, i) : r === "/danh-sach/day" ? E(t, i) : r === "/phieu/day" ? C(t, i) : r === "/phieu/xoa" ? T(t, String(i.ma ?? "")) : r === "/chua-day" ? N(t, String(i.maCa ?? "")) : r === "/da-day" ? P(t, i) : r === "/ca/bat-dau" ? S(t, String(i.maCa ?? "")) : r === "/theo-doi" ? j(t, String(i.maCa ?? "")) : r === "/ca/luot" ? A(t, String(i.maCa ?? "")) : r === "/cho" ? M(t, String(i.maCa ?? "")) : c({
		ok: !1,
...
//#endregion
export { L as default, f as dieuKienLuot };

...
async function f(e, t) {
	...
	let d = await l(e, a), f = await u(e, a, o), p = Date.now(), m = n(d, f, c, p);
	if (!m.ok || !d) return s({
		ok: !1,
		lyDo: m.lyDo,
		lanThu: m.lanThu,
...
var j = { async fetch(e, t) {
	...
	return r === "/vao-thi" ? f(t, i) : r === "/luu-tam" ? p(t, i) : r === "/nop" ? m(t, i) : r === "/trang-thai" ? h(t, i) : r === "/phong-cho" ? v(t, i) : c(e, t, i) ? r === "/ca/day" ? b(t, i) : r === "/phieu/day" ? S(t, i) : r === "/phieu/xoa" ? w(t, String(i.ma ?? "")) : r === "/chua-day" ? D(t, String(i.maCa ?? "")) : r === "/da-day" ? O(t, i) : r === "/ca/bat-dau" ? x(t, String(i.maCa ?? "")) : r === "/theo-doi" ? T(t, String(i.maCa ?? "")) : r === "/cho" ? E(t, String(i.maCa ?? "")) : s({
		ok: !1,
...
//#endregion
export { j as default, d as dieuKienLuot };

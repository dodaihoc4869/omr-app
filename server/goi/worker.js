...
var O = { async fetch(e, t) {
	...
	return r === "/vao-thi" ? f(t, i) : r === "/luu-tam" ? p(t, i) : r === "/nop" ? m(t, i) : r === "/trang-thai" ? h(t, i) : r === "/phong-cho" ? v(t, i) : c(e, t, i) ? r === "/ca/day" ? b(t, i) : r === "/chua-day" ? w(t, String(i.maCa ?? "")) : r === "/da-day" ? T(t, i) : r === "/ca/bat-dau" ? x(t, String(i.maCa ?? "")) : r === "/theo-doi" ? S(t, String(i.maCa ?? "")) : r === "/cho" ? C(t, String(i.maCa ?? "")) : s({
		ok: !1,
...
//#endregion
export { O as default, d as dieuKienLuot };

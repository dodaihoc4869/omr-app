...
cp scripts/bo-nao/lay.mjs scripts/bo-nao/nop.mjs scripts/bo-nao/chung.mjs scripts/bo-nao/cau-hinh.mjs scripts/bo-nao/chay-tay.sh scripts/bo-nao/chay-dem.sh scripts/bo-nao/chay-chieu.sh "$DICH/scripts/bo-nao/"
cp src/lib/bo-nao-khuon.ts src/lib/bo-nao-nen.ts src/lib/bo-nao-vang.ts src/lib/btvn-nang-do.ts "$DICH/src/lib/"
...
cp bo-nao/HUONG-DAN-BO-NAO.md bo-nao/LOI-DAN-PHIEN.md bo-nao/LUAT-RUT-GON.md bo-nao/LOI-DAN-CHIEU.md bo-nao/LUAT-CHIEU.md "$DICH/bo-nao/"

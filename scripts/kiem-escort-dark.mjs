...
await page.emulateMedia({colorScheme:'dark'});await page.goto(base+'/hs');await page.getByRole('button',{name:/Thần Thú/i}).first().click();await page.getByRole('button',{name:'Hộ Tống Linh Tâm',exact:true}).click()

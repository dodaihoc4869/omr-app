...
await page.getByText('🛡 Khiên chống đuổi · 6 lượt',{exact:true}).waitFor()
await page.getByRole('button',{name:'Dùng Khiên chống đuổi'}).click()
...
await page.getByText('🛡 Khiên chống đuổi · 5 lượt',{exact:true}).waitFor()

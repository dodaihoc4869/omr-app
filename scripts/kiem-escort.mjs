...
await page.locator('.escort-shell').screenshot({path:'/tmp/linh-tam-desktop.png'})
...
await page.setViewportSize({width:390,height:844});await page.locator('.escort-shell').screenshot({path:'/tmp/linh-tam-mobile.png'})

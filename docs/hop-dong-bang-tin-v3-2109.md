...
## Rào
- `soTruyVan ≤ 12` (thực tế 11); không ghi; không AI; tên em chỉ ở lệnh thầy. Tài khoản thử 12121212 không tính vào số liệu lớp. Sổ học đọc tối đa 14 ngày gần nhất (chuỗi bền bỉ tối đa 14 ngày). Đáp án, điểm, hạn nộp, luật chấm không đổi.

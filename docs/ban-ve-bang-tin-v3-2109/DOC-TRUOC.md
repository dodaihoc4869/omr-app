...
- Màu trong bản vẽ là hex thô để vẽ nhanh ⇒ trong `src/` PHẢI đổi sang token sẵn có (check:mau đang xanh, giữ xanh); thiếu token thì thêm vào `src/styles/tokens.css` có cặp sáng/tối. Ô "A.I Đỗ Đại Học đã tự làm hôm nay" nền đậm ở CẢ sáng và tối.
...
- THẦY LỆNH THÊM 21/09 ~11:50: **thay toàn bộ chữ "Máy" (khi là chủ ngữ làm việc tự động) bằng "A.I Đỗ Đại Học"** — tiêu đề ô: "A.I Đỗ Đại Học đã tự làm hôm nay"; dòng dưới mỗi bài: "A.I Đỗ Đại Học đã nhắc 9 em chưa mở · lượt nhắc kế 20:00"; chân ô: "Hệ thống bình thường · thầy không cần làm gì". Trong 3 tệp .dc.html chữ cũ "Máy…" đọc là chữ mới này.

...
**Export CHÍNH THỨC 21/09/2026 02:26 giờ VN** → `/Volumes/SSD NGOÀI/omr-saoluu/omr-d1-20260921-0225.sql` (110.628.618 byte, 66 bảng). Kiểm: nạp được vào SQLite bộ nhớ trong 0,8 giây; có `luot` (265 dòng) và `su_kien_hoc` (26.445 dòng); số dòng MỌI bảng khớp `/reset/dry-run` chạy ngay sau đó, không lệch dòng nào. Không có ca thi mở lúc export. Bookmark Time Travel ngay sau export: `0000023b-000075d1-000050ec-7f2aa33e1ff262de1abb73eeffa606e2` (khôi phục: `cd server && npx wrangler d1 time-travel restore omr --bookmark=0000023b-000075d1-000050ec-7f2aa33e1ff262de1abb73eeffa606e2`). Bookmark SÁT lúc lên đạn ghi thêm ở đây khi lên đạn.

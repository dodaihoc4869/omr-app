...
## 14 · THẦY CHỐT 21/09 (mới nhất): KHÔNG chạy thử — CHẠY THẬT LUÔN, thầy không bấm gì
Bỏ giai đoạn "2 đêm chạy thử". Ngay khi đủ ba mảnh — (1) máy chủ biết ĐỌC điều chỉnh (kế hoạch ngày + BTVN nâng đỡ + lời nhắn), (2) thẻ "Bộ não A.I hỗ trợ riêng em…" trên app học sinh + phụ huynh, (3) hai mã lệnh + tác vụ hẹn giờ 04:00 — Boss cho đặt `cheDo:'that'` cho CẢ TRƯỜNG. Rào an toàn giữ nguyên và là thứ duy nhất đứng giữa AI và học sinh: kiểm khuôn HAI lớp (máy thầy + máy chủ), tin cậy ≥ 0,6 mới áp, ≤ 2 đổi/em/đêm, tự hết hạn 3 ngày, hôm sau tự chấm — xấu đi thì tự gỡ, deadline thắng mọi núm, công tắc tắt ở Cài đặt. Boss đọc mẫu lời nhắn SAU mỗi đêm trong tuần đầu; lời lệch giọng ⇒ sửa cẩm nang ngay trong ngày (không chặn việc chạy). Việc thầy có thể phải làm: KHÔNG — trừ khi hệ điều hành/app tự bật hộp hỏi quyền mà chỉ thầy bấm được; Boss chỉ báo khi điều đó xảy ra.
